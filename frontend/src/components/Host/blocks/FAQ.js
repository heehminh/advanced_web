...
const FAQ = () => {
  ...
  const questions = [
    {
      id: 1,
      title: "제 공간이 여행집 숙소로 적합할까요?",
      content:
        "여행집 게스트가 찾는 숙소는 매우 다양하며, 여행집에서는 초소형 주택, 통나무집, 트리하우스 등 다양한 유형의 숙소가 등록되어 있습니다. 집에 남는 방 한 칸이라도 훌륭한 숙소가 될 수 있습니다.",
    },
    {
      id: 2,
    ...
    {
      id: 4,
      title: "훌륭한 여행집 호스트가 되기 위한 팁이 있나요?",
      content:
    ...
    {
      id: 5,
      title: "여행집 수수료는 얼마인가요?",
      content:
        "일반적으로 여행집은 호스팅 대금에서 예약 소계의 3%에 해당하는 금액을 고정 서비스 수수료로 차감합니다. 또한 예약하는 게스트에게도 수수료를 부과합니다. 여행집은 상당수 지역에서 호스트를 대신해 자동으로 판매세 및 관광세를 징수·납부합니다.",
    },
  ];
